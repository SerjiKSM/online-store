...
CREATE TABLE `products_stocks` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_product_fk_constraint` (`id_product`),
  CONSTRAINT `id_product_fk_constraint` FOREIGN KEY (`id_product`) REFERENCES `products` (`product_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
LOCK TABLES `products_stocks` WRITE;
/*!40000 ALTER TABLE `products_stocks` DISABLE KEYS */;
INSERT INTO `products_stocks` VALUES (1,1,850),(3,2,400),(6,10,50),(7,11,20),(8,4,55),(11,16,10),(12,18,500);
